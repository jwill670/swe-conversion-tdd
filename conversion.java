...
public class conversion
{
     ...
     */
    private static float roundNum(float num, int decimalPrecision) {
     ...
     */
    private static float genericConvert(String XAsStr, float conversionFormula, int decimalPrecision) {
        float num1, num2;
